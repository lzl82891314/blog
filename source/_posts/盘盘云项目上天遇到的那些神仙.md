...
说了这么多，我们可以通过一个栗子看看 Deployment 是如何工作的。由于 Forguncy 的镜像配置过于复杂，因此这里我们通过一个 Nginx 的多副本配置来感受一下 Deployment 控制器的控制结果，我们可以通过以下 yaml 定义一个维护了 3 个 nginx 副本的 deployment：
